 ...
 *
 * @author Matt, Zuoyuan Zhao Please implement this so that the visualizer can
 * see your stuff.
 */
public interface FloorPositions {
    ...
    /**
     *
     * @return A map | Keys are objects on the floor--perhaps object Id | Values
     * are a data structure | Containing positions, type of object | Later, we
     * can add more info, but for now that should be enough
     *
